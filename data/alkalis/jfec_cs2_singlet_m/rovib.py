...
replace(inputfile, ' R0', R0) #editing inputfile such that L=L is called
replace(inputfile, ' BETA', BETA) #editing inputfile such that L=L is called
replace(inputfile, ' DHART', De) #editing inputfile such that L=L is called
