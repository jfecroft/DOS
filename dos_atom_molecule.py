...
for system in Jfec_AlkaliAtomPlusDimer.systems.keys():
 Jfec_AlkaliAtomPlusDimer.get_dos_AtomMolecule(system,J=J,MQN=MQN,nmax=nmax,vmax=vmax,energy_offset=collision_energy)
...
for system in Mayle_AlkaliAtomPlusDimer.systems.keys():
 Mayle_AlkaliAtomPlusDimer.get_dos_AtomMolecule(system,J=J,MQN=MQN,nmax=nmax,vmax=vmax,energy_offset=collision_energy)
...
for system in HeliumPlusHydrocarbon.systems.keys():
 HeliumPlusHydrocarbon.get_dos_AtomMolecule(system,J=J,MQN=MQN,nmax=nmax,vmax=vmax,energy_offset=collision_energy)
